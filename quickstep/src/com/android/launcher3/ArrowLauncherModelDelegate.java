...
public class ArrowLauncherModelDelegate extends QuickstepModelDelegate
    implements SmartspaceSession.OnTargetsAvailableListener {

    public static final String TAG = "ArrowLauncherModelDelegate";
    ...
    public ArrowLauncherModelDelegate(Context context) {
        super(context);
        mContext = context;
    }
